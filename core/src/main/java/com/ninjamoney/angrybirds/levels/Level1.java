...
////
////        chuck = new Chuck();
////        chuck.setBirdBody(createCircle(48, 80   , 20f, false)); // Initialize the Chuck bird body
////
////        bomb = new Bomb();
...
////
////        // Draw Red bird
////        batch.draw(red.getBirdTexture(), red.getRedBody().getPosition().x-20, red.getRedBody().getPosition().y-20 , 40, 40);
////
////        // Draw Bomb bird
////        batch.draw(bomb.getBirdTexture(), bomb.getBombBody().getPosition().x - 30f, bomb.getBombBody().getPosition().y - 25f, 60, 60);
////        batch.draw(chuck.getBirdTexture(), chuck.getChuckBody().getPosition().x - 20f, chuck.getChuckBody().getPosition().y - 20f, 40, 40);
////
...
//        batch.draw(bomb.getBirdTexture(), bomb.getBombBody().getPosition().x - 30f, bomb.getBombBody().getPosition().y - 25f, 60, 60);
//
//        // Draw Chuck on top of the slingshot
//        batch.draw(chuck.getBirdTexture(), chuck.getChuckBody().getPosition().x - 20f, chuck.getChuckBody().getPosition().y - 20f, 40, 40);
//
//        // Draw the structure (boxes)
//        for (Body box : boxes) {
