...
import com.ninjamoney.angrybirds.elements.struct.*;
...
public class Level3 implements Screen, PigHealthListener {
    ...
    private Collisions collisionListener;
    ...
    public Level3(AngryBirds game, int levelNumber, boolean isLocked) {
        ...
        rockCircleTexture = new Texture("elements/struct/rock_circle.png");
        ...
        c1 = createCircle(4 * stage.getWidth() / 5, stage.getHeight() / 5, 25, false);
        c2 = createCircle(4 * stage.getWidth() / 5 - 200, stage.getHeight() / 5, 25, false);
...
//        boxes.add(createCircle(4 * stage.getWidth() / 5, stage.getHeight() / 5, 50, false));
...
//        boxes.add(new Rock(world, "rockBlock", 4 * stage.getWidth() / 5 - 200, stage.getHeight() / 5, 50, 50).getBody());
        ...
        Ice fourthBox = new Ice(world, "block", 4 * stage.getWidth() / 5 - 150, stage.getHeight() / 5 + 140, 20, 120);
        ...
        Ice fifthBox = new Ice(world, "block", 4 * stage.getWidth() / 5 - 50, stage.getHeight() / 5 + 140, 20, 110);
        ...
        boxes.add(new Rock(world, "rockPlank", 4 * stage.getWidth() / 5 - 150, stage.getHeight() / 5 + 260, 20, 140).getBody());
        boxes.add(new Rock(world, "rockPlank", 4 * stage.getWidth() / 5 - 50, stage.getHeight() / 5 + 260, 20, 140).getBody());

        Ice sixthBox = new Ice(world, "block", 4 * stage.getWidth() / 5 - 110, stage.getHeight() / 5 + 400, 20, 120);
        sixthBox.getBody().setTransform(sixthBox.getBody().getPosition(), (float) Math.toRadians(90));
        boxes.add(sixthBox.getBody());
        Rock eighthBox = new Rock(world, "rockBlock", 4 * stage.getWidth() / 5 - 100, stage.getHeight() / 5 + 420, 50, 50);
    ...
    public void render(float delta) {
        ...
        for (Body box : boxes) {
            ...
            if(box.getUserData() instanceof Ice){
                Ice ice = (Ice) box.getUserData();
                TextureRegion iceTR = new TextureRegion(ice.getIceTexture());
                iceTR.flip(true, true);
                batch.draw(iceTR, pos.x - size.x / 2, pos.y - size.y / 2, size.x / 2, size.y / 2, size.x, size.y, 1, 1, (float) Math.toDegrees(angle));
            }
...
//        Texture rc = new Texture("elements/struct/rock_circle.png");
        TextureRegion rockCircle = new TextureRegion(rockCircleTexture);
        batch.draw(rockCircle,c1.getPosition().x-27, c1.getPosition().y-23,
            20, 20,50,50,1,1,(float) Math.toDegrees(0));
        batch.draw(rockCircle,c2.getPosition().x-23, c2.getPosition().y-23,
            20, 20,50,50,1,1,(float) Math.toDegrees(0));
//        rc.dispose();
    ...
    public void dispose() {
        ...
        if (rockCircleTexture != null) rockCircleTexture.dispose();
