...
//            @Override
//            public void clicked(InputEvent event, float x, float y) {
//                gameState = GameStateListener.loadLevelWiseGameData(1);
//                if(gameState != null) {
    ...
    private void createButtons() {
        ...
        level1Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                gameState = GameStateListener.loadLevelWiseGameData(1);
                if(gameState != null) {
                    System.out.println("Game state for level 1 loaded successfully.");
                    game.setScreen(new Level1(game, 1, false, gameState));
                } else {
                    System.out.println("No saved game state for level 1. Starting new game.");
                    game.setScreen(new Level1(game, 1, false, null));
                }
            }
        });
        ...
        level2Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                if(Level1.cleared) {
                    gameState = GameStateListener.loadLevelWiseGameData(2);
                    if(gameState != null) {
                        System.out.println("Game state for level 2 loaded successfully.");
                        game.setScreen(new Level2(game, 2, false));
                    } else {
                        System.out.println("No saved game state for level 2. Starting new game.");
                        game.setScreen(new Level2(game, 2, false));
                    }
                }
            }
        ...
        level3Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                if(Level2.cleared) {
                    gameState = GameStateListener.loadLevelWiseGameData(3);
                    if(gameState != null) {
                        System.out.println("Game state for level 3 loaded successfully.");
                        game.setScreen(new Level3(game, 3, true));
                    } else {
                        System.out.println("No saved game state for level 3. Starting new game.");
                        game.setScreen(new Level3(game, 3, true));
                    }
                }
            }
